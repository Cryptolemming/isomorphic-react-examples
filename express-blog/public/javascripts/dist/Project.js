	...
	var Project = React.createClass({
		...
		render: function render() {
			if (this.state.project) {
				...
				return React.createElement('div', { style: {} }, React.createElement('h1', { style: { marginTop: '50px' } }, project.name), React.createElement('h5', { style: { marginBottom: '15px', fontSize: 15 } }, date), React.createElement('img', { src: project.picture, style: { width: '250px', marginLeft: '5px' } }), React.createElement('p', {
					style: {
						opacity: '.8',
						fontSize: '10px'
