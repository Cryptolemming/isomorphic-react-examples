			...
			if (this.state.projects) {
				var projectItemElements = this.state.projects.map(function (project, index) {
					...
					return React.createElement('li', {
						key: index,
						style: {} }, React.createElement('a', { href: window.location.href + '/' + project.name_slug }, React.createElement('h1', { style: { marginTop: '50px', fontSize: '35px' } }, project.name)), React.createElement('h5', { style: { marginBottom: '25px', fontSize: 15 } }, date), React.createElement('img', { src: project.picture, style: { width: '250px', marginLeft: '5px' } }), React.createElement('p', {
						style: {
							opacity: '.8',
							fontSize: '10px'
						} }, project.languages), React.createElement('p', { style: { marginLeft: '5px', marginBottom: '25px', marginTop: '25px' } }, project.summary));
				});
