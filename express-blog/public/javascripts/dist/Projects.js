			...
			if (this.state.projects) {
				var projectItemElements = this.state.projects.map(function (project, index) {
					...
					return React.createElement('li', {
						key: index,
						style: { listStyleType: 'none' } }, React.createElement('a', { href: window.location.href + '/' + project.name_slug }, React.createElement('h1', { style: { marginTop: '50px' } }, project.name)), React.createElement('h5', { style: { marginBottom: '15px' } }, date), React.createElement('img', { src: project.picture, style: { width: '250px', marginLeft: '5px' } }), React.createElement('p', {
						style: {
							opacity: '.8',
							fontSize: '10px'
